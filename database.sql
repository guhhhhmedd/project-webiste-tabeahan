...
INSERT INTO `jawaban_peserta` VALUES (73,28,'',1,13,'c'),(162,28,'',1,2,'c'),(163,28,'',1,1,'a'),(164,28,'',1,3,'b'),(165,28,'',1,37,'b'),(166,28,'',1,38,'b'),(167,28,'',1,39,'c'),(272,48,'',1,9,'a'),(273,48,'',1,10,'a'),(274,48,'',1,11,'a'),(275,48,'',1,46,'a'),(276,48,'',1,12,'a'),(277,48,'',1,47,'a'),(278,48,'',1,45,'a'),(279,48,'',1,48,'a'),(310,28,'',1,54,'c'),(311,28,'',1,55,'a'),(312,28,'',1,58,'c'),(313,28,'',1,59,'c'),(314,28,'',1,60,'c'),(315,28,'',1,56,'a'),(316,28,'',1,57,'a'),(384,28,'',1,61,'a'),(385,28,'',1,63,'a'),(387,28,'',1,62,'a'),(400,50,'',1,59,NULL),(401,50,'',1,63,'c'),(402,50,'',1,60,NULL),(403,50,'',1,55,'a'),(404,50,'',1,62,'a'),(405,50,'',1,61,'c'),(406,50,'',1,56,'a'),(407,50,'',1,54,'b'),(408,50,'',1,57,'c'),(409,50,'',1,58,'c'),(433,51,'Paket SKD/TKD',1,62,NULL),(470,53,'Paket PPPK',1,9,'a'),(471,53,'Paket PPPK',1,10,'b'),(472,53,'Paket PPPK',1,11,'c'),(473,53,'Paket PPPK',1,12,'c'),(474,53,'Paket PPPK',1,45,'a'),(475,53,'Paket PPPK',1,46,'b'),(476,53,'Paket PPPK',1,47,'b'),(477,53,'Paket PPPK',1,48,'a'),(478,53,'Paket PPPK',1,69,'a'),(479,54,'Paket PPPK',1,9,'c'),(480,54,'Paket PPPK',1,10,'d'),(481,54,'Paket PPPK',1,11,'b'),(482,54,'Paket PPPK',1,12,'a'),(483,54,'Paket PPPK',1,45,'a'),(484,54,'Paket PPPK',1,46,'b'),(485,54,'Paket PPPK',1,47,'c'),(486,54,'Paket PPPK',1,48,NULL),(487,54,'Paket PPPK',1,69,'b'),(497,55,'Paket SKD/TKD',1,54,'a'),(498,55,'Paket SKD/TKD',1,55,'a'),(499,55,'Paket SKD/TKD',1,56,'b'),(500,55,'Paket SKD/TKD',1,57,'c'),(501,55,'Paket SKD/TKD',1,58,'c'),(502,55,'Paket SKD/TKD',1,59,NULL),(503,55,'Paket SKD/TKD',1,60,NULL),(504,55,'Paket SKD/TKD',1,61,'a'),(505,55,'Paket SKD/TKD',1,62,NULL),(506,55,'Paket SKD/TKD',1,63,NULL),(520,51,'Paket SKD/TKD',1,54,'a'),(521,51,'Paket SKD/TKD',1,55,'c'),(522,51,'Paket SKD/TKD',1,56,'a'),(523,51,'Paket SKD/TKD',1,57,'c'),(524,51,'Paket SKD/TKD',1,58,'c'),(525,51,'Paket SKD/TKD',1,59,NULL),(526,51,'Paket SKD/TKD',1,60,NULL),(527,51,'Paket SKD/TKD',1,61,'b'),(528,51,'Paket SKD/TKD',1,63,NULL),(529,51,'Paket SKD/TKD',1,72,NULL),(530,51,'Paket SKD/TKD',1,73,NULL);
...
--
-- Table structure for table `paket_pg_subtest`
--

DROP TABLE IF EXISTS `paket_pg_subtest`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `paket_pg_subtest` (
  `id` int NOT NULL AUTO_INCREMENT,
  `paket_id` int NOT NULL,
  `materi_id` int NOT NULL,
  `nama_materi` varchar(100) NOT NULL DEFAULT '',
  `min_skor` int NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_paket_materi` (`paket_id`,`materi_id`),
  CONSTRAINT `paket_pg_subtest_ibfk_1` FOREIGN KEY (`paket_id`) REFERENCES `paket_ujian` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `paket_pg_subtest`
--

LOCK TABLES `paket_pg_subtest` WRITE;
/*!40000 ALTER TABLE `paket_pg_subtest` DISABLE KEYS */;
INSERT INTO `paket_pg_subtest` VALUES (1,1,1,'twk',7),(2,1,2,'tiu',9),(3,1,3,'tkp',10);
/*!40000 ALTER TABLE `paket_pg_subtest` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `paket_to`
--

DROP TABLE IF EXISTS `paket_to`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `paket_to` (
  `id` int NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `paket_to`
--
...
CREATE TABLE `paket_ujian` (
  ...
  `deskripsi` text,
  `pg_type` enum('PER_SUBTEST','PERSENTASE','PERINGKAT') NOT NULL DEFAULT 'PERINGKAT',
  `pg_kumulatif` int DEFAULT NULL,
  `pg_min_persen` decimal(5,2) DEFAULT NULL,
  `pg_skor_maks` int DEFAULT NULL,
...
INSERT INTO `paket_ujian` VALUES (1,'Paket SKD/TKD',100,7,50000,100000,'Latihan soal SKD/TKD lengkap untuk seleksi CPNS dan sekolah kedinasan.','PER_SUBTEST',311,NULL,550,NULL,1),(2,'Paket Akademik Polri',90,10,50000,100000,'Persiapan ujian akademik Polri untuk jalur Bintara dan Akpol.','PERSENTASE',NULL,70.00,125,NULL,1),(3,'Paket PPPK',50,8,50000,100000,'Latihan soal PPPK untuk tenaga guru, teknis, dan fungsional.','PERINGKAT',NULL,NULL,670,NULL,1);
...
INSERT INTO `riwayat_subtest` VALUES (24,48,1,'TWK',3,2,1,10.00,15.00,'2026-07-05 05:23:10'),(25,48,2,'TIU',6,3,3,15.00,30.00,'2026-07-05 05:23:10'),(26,48,3,'TKP',2,2,0,5.00,10.00,'2026-07-05 05:23:10'),(27,49,1,'TWK',3,2,1,10.00,15.00,'2026-07-11 16:42:30'),(28,49,2,'TIU',6,0,6,0.00,30.00,'2026-07-11 16:42:30'),(29,49,3,'TKP',2,0,2,0.00,10.00,'2026-07-11 16:42:30');
...
INSERT INTO `riwayat_ujian` VALUES (48,51,'Paket SKD/TKD',1,30,7,11,'2026-07-05 12:23:10',1),(49,51,'Paket SKD/TKD',1,10,2,11,'2026-07-11 23:42:30',1);
...
-- Dump completed on 2026-07-11 23:52:29
